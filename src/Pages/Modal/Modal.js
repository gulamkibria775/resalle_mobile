    ...
    <>
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <h3 className="text-lg font-bold">category: {singleitem.categore}</h3>
          <p className="py-4 font-bold">seller_name:{singleitem.seller_name}</p>
          ...
          <input type="text" placeholder="Type here" className="input w-full max-w-xs" /> */}
            ...
            <br />
            <input
              className="btn btin-primary w-full "
              type="submit"
              value="Submit"
            />
          </form>
